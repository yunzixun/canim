...
extension KeyButton {
        func setupKeyButtonView() {
                ...
                keyButtonView.topAnchor.constraint(equalTo: topAnchor, constant: 5).isActive = true
                keyButtonView.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -5).isActive = true
